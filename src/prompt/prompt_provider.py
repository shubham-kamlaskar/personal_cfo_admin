class Prompt:
   ...
   OUT_OF_SCOPE_PROMPT = """If the requested query is not related to software testing work then simply say 'Sorry, At this moment I can only help in software testing task.'."""
